...
notify-send -i "${ICON_PATH}" "Font Installed" "${FONT_NAME} Nerd Font (version ${FONT_VERSION}) has been successfully installed." --icon=dialog-information --app-name="Nerd Font Installer"
